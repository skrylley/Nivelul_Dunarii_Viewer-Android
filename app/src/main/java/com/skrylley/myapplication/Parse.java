...
public class Parse extends AsyncTask<Void, Void, Void> {
    ...
    protected void onPostExecute(Void result) {
        ...
        // Aici puteți utiliza variabilele de instanță pentru a actualiza TextView-urile în AllActivity
        ...
        /*Log.d("Parse", "valLocalitate: " + Arrays.toString(valLocalitate));
        Log.d("Parse", "valKm: " + Arrays.toString(valKm));
        Log.d("Parse", "valNivel: " + Arrays.toString(valNivel));
        Log.d("Parse", "valVariatie: " + Arrays.toString(valVariatie));*/
    }
}
